...
:vs
    ...
    rem /showIncludes
    cl.exe -nologo /DNOTEBOOK=1 /D_PLATF=1 /D_ARCH=1 !opt! !warn! /I!fsrc!include !fsrc!!project!.cpp /Fe!froot!!project!.exe /link USER32.lib GDI32.lib OPENGL32.lib /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /OPT:REF
...
:llvm
    ...
    set warn=-Wall -Wno-unused-variable -Wno-unused-function -Wno-tautological-compare -Wno-non-pod-varargs -Wno-invalid-offsetof
    rem set warn=-Wall -Wno-unused-variable -Wunused-function -Wno-tautological-compare -Wno-non-pod-varargs -Wno-invalid-offsetof
    rem -fmax-errors=5
...
:gengl
    ...
    echo // This file was generated by 'build.bat genGLList'> !fsrc!\oglInterface_funcNames.h
    echo // This file was generated by 'build.bat genGLList'> !fsrc!\oglInterface_funcWrappers.h
    
    echo|set /p="#define OGL_FUNC_NAMES " >> !fsrc!\oglInterface_funcNames.h
    ...
    for /f "tokens=*" %%a in (!fsrc!\ogl_proc_list.txt) do (
        ...
        if not [!first_char!] == [#] (
            ...
            if [!exported_by_OpenGL32_dll!] == [0] (
                ...
                echo|set /p="\">>!fsrc!\oglInterface_funcNames.h
                rem echo newline
                echo.>> !fsrc!\oglInterface_funcNames.h
                echo|set /p="X(%%a, !fpType!) ">> !fsrc!\oglInterface_funcNames.h
                
                echo #define %%a^(...^) CALL_OGL_FUNC_TBL^(%%a, __VA_ARGS__^)>> !fsrc!\oglInterface_funcWrappers.h
    ...
    echo // This file was generated by 'build.bat genGLList'> !fsrc!\oglInterface_funcCount.h
    echo !count!>> !fsrc!\oglInterface_funcCount.h
