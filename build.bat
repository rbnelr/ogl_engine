...
:vs
	...
	rem /showIncludes
	cl.exe -nologo /D_PLATF=1 /D_ARCH=1 !opt! !warn! /I!fsrc!include /I!froot!../include !fsrc!!project!.cpp /Fe!froot!!project!.exe /link USER32.lib GDI32.lib OPENGL32.lib Ws2_32.lib /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /OPT:REF
